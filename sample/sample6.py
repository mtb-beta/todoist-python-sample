...
class TodoistApp():
    ...
    def get_proceed_items(self):
        return ItemList(self.items).filter_want_proceed()

def main():
    app = TodoistApp()
    items = app.get_proceed_items()
